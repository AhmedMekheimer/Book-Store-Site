...
namespace Online_Book_Store.Migrations
{
    ...
    [Migration("20250701092038_UploadedFileTable_DeleteBehavior_ClientSetNullWithConstraints")]
    partial class UploadedFileTable_DeleteBehavior_ClientSetNullWithConstraints
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Online_Book_Store.Models.UploadedFile", b =>
                {
                    ...
                    b.ToTable("UploadedFiles", t =>
                        {
                            t.HasCheckConstraint("CK_UploadedFiles_SingleOwner", "(IIF(AuthorId IS NULL, 0, 1) + IIF(BookId IS NULL, 0, 1) + IIF(PublishingHouseId IS NULL, 0, 1) + IIF(CategoryId IS NULL, 0, 1)) = 1");
                        });
                });
